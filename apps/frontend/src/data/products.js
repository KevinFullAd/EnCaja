...
import { expandCatalogToProducts } from "./expandCatalog";
/**
 * CATALOG: estructura normalizada para BD
 * - base product (familia) -> flavors (recetas) -> variants (simple/doble/triple)
 * - imageUrl puede estar en base o en variant (si querés imagen específica)
 */
...
export const PRODUCTS = expandCatalogToProducts(CATALOG);