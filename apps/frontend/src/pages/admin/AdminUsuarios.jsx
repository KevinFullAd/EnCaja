                        ...
                        {!loading && usuarios.map((u) => (
                            <tr key={u.id} className="border-b border-(--app-border) hover:bg-(--app-bg)">
                                ...
                                <td className="px-4 py-3 text-right space-x-3">
                                    <button onClick={() => handleAskDelete(u)} className="text-gray-400 hover:text-red-500 transition-colors">
                                        <Trash2 size={15} />
                                    </button>
                                    <button onClick={() => setEditor({ data: u })} className="text-gray-500 hover:text-black transition-colors">
                                        <Pencil size={15} />
                                    </button>
                                </td>
                            </tr>
